...
def main():
    ...
    while True:
        ...
        def get_rectang(bastaopky_x,bastapky_y, kazir_x, kazyr_y):
            return pygame.Rect(min(bastaopky_x,kazir_x), min(bastapky_y,kazyr_y), abs(bastaopky_x-kazir_x), abs(bastapky_y-kazyr_y))
